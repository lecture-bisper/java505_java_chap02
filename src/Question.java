...
//        95이상 = A+, 90이상 = A, 85이상 = B+, 80이상 = B, 75이상 = C+, 70이상 = C, 60이상 = D, 60미만 = F
        ...
        money = money % 50000; //        5만원을 뺀 15,245원을 변수 money에 저장
        ...
        int m500 = money / 500; // 245에서 500원 동전의 수를 확인하기 위해서 500으로 나눔
        money = money % 500; // 500을 나누 후 나머지 금액으 계산하기 위해서 나머지 연산, 245 그대로 남음
        ...
        System.out.println("일원 동전 " + money + "개");
